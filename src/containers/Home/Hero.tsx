  ...
  return (
    ...
    >
      ...
      <p className="hero__desc">
        Không gian sức khoẻ của tôi cho phép bạn lưu trữ và chia sẻ dữ liệu và
        tài liệu sức khoẻ của mình một cách hoàn toàn bảo mật
      </p>
      <div className="hero__btns">
        <ButtonCustom className="hero__btns--profile">Xem hồ sơ y tế của tôi</ButtonCustom>
        <ButtonCustom className="hero__btns--doc">Thêm tài liệu về sức khoẻ</ButtonCustom>
      </div>
